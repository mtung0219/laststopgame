...
public class MenuHandlerScript : MonoBehaviour
{
    ...
    {
        cmra.transform.position = new Vector3(cmra.transform.position.x + 17, cmra.transform.position.y, cmra.transform.position.z);
    }
    public void GoToOtherScene()
    {
        Debug.Log("going to other scene");
        SceneManager.LoadScene("RestorationPuzzle");
    }
